...
import "./bpoComment.scss";

interface BPOCommentProps {
    commentData: BpoCommentHistoryResponse;
}

const BPOComment: FC<BPOCommentProps> = (props) => {
    ...
    return (
        <>
            <div className="bpo-comment-container">
...
export default memo(BPOComment);
