...
interface BPOEvaluatorProps {
    resultData: RatingUsers;
    rlistingId: number;
    index: number;
    ratingId: number;
}
const BPOEvaluator: FC<BPOEvaluatorProps> = (props) => {
    ...
    return (
        <div className="bpo-evaluator-container">
...
export default memo(BPOEvaluator);
