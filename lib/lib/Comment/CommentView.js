...
var CommentView = function (props) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "comment-container" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "comment-container__item" }, { children: dataTransformCategories.map(function (category, index) {
                return category.categoryId === 28 ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [category.showTextInput && ((0, jsx_runtime_1.jsx)(PriceTags_1.PriceTags, { id: category.categoryId.toString(), showLimit: true, placeholderText: category.placeHolderTextInput, allowChange: true, tags: [], suggestions: category.comments ? category.comments : [], onHandleChange: onHandleChangeTag, noSuggestionsText: "Kh\u00F4ng c\u00F3 d\u1EEF li\u1EC7u", categoryId: category.categoryId, requiredTextInput: category.requiredTextInput, dataTypeTextInput: category.dataTypeTextInput }, void 0)), props.errorsConfig.length > 0 &&
                            props.errorsConfig[index].errorInput && ((0, jsx_runtime_1.jsx)("p", __assign({ className: "title-red" }, { children: "Vui l\u00F2ng nh\u1EADp n\u1ED9i dung" }), void 0))] }, void 0)) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ImageItem_1.ImageItem, { onHandleChangeImage: onHandleChangeImage, categoryId: category.categoryId, showPhoto: category.showPhoto, requiredTextInput: category.requiredTextInput, categoryName: category.categoryName }, void 0), props.errorsConfig.length > 0 &&
                            props.errorsConfig[index].errorImage && ((0, jsx_runtime_1.jsx)("p", __assign({ className: "title-red" }, { children: "Vui l\u00F2ng th\u00EAm h\u00ECnh \u1EA3nh" }), void 0)), category.showTextInput && ((0, jsx_runtime_1.jsx)(InputTags_1.InputTags, { id: category.categoryId.toString(), showLimit: true, placeholderText: category.placeHolderTextInput, allowChange: true, tags: [], suggestions: category.comments ? category.comments : [], onHandleChange: onHandleChangeTag, noSuggestionsText: "Kh\u00F4ng c\u00F3 d\u1EEF li\u1EC7u", categoryId: category.categoryId, requiredTextInput: category.requiredTextInput, dataTypeTextInput: category.dataTypeTextInput }, void 0)), props.errorsConfig.length > 0 &&
                            props.errorsConfig[index].errorInput && ((0, jsx_runtime_1.jsx)("p", __assign({ className: "title-red" }, { children: "Vui l\u00F2ng nh\u1EADp n\u1ED9i dung" }), void 0))] }, void 0));
            }) }), void 0) }), void 0));
};
exports.default = (0, react_1.memo)(CommentView);
